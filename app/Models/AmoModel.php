...
class AmoModel extends Model{
    ...
    public function getAllAmosList(){
        return $this->select("idAmo, nombreAmo, apellidoAmo")->where("amos.deleted_at IS NULL")->orderBy("nombreAmo","asc")->findAll();
    }
    public function getAllAmos(){
        return $this->select("nombreAmo, apellidoAmo, telefonoAmo, fechaAltaAmo")->where("amos.deleted_at IS NULL")->orderBy("nombreAmo","asc")->findAll();
    }
